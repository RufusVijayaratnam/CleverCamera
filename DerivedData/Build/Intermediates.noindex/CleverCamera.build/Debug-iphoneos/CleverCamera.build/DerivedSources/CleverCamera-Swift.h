...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CleverCamera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CleverCamera11AppDelegate")
...
SWIFT_CLASS("_TtC12CleverCamera11BTDiscovery")
...
SWIFT_CLASS("_TtC12CleverCamera9BTService")
...
SWIFT_CLASS("_TtC12CleverCamera13SceneDelegate")
...
SWIFT_CLASS("_TtC12CleverCamera12myController")
@interface myController : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)viewDidLoad;
